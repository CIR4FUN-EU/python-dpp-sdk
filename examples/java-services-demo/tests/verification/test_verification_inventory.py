...
from dpp_java_services_demo import controlled_scenarios, registry_scenarios, repository_scenarios
from dpp_java_services_demo.sdk_scenarios import SCENARIOS
