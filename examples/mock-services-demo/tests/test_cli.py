...
from dpp_mock_services_demo import __main__ as cli
from dpp_mock_services_demo.config import DemoConfig
from dpp_mock_services_demo.fixtures import DemoIdentity
from dpp_mock_services_demo.image_identity import (
    ImageEquivalence,
    ImageIdentityReport,
    RuntimeImageIdentity,
)
from dpp_mock_services_demo.integration_scenarios import run_integration_scenarios
from dpp_mock_services_demo.reporting import LiveRun, ScenarioResult, ScenarioStatus
...
def test_verify_writes_atomic_json_report(
    ...
    assert exit_code == 0
    assert "PYTHON_MOCK_SERVICES_INTEROPERABILITY_VERIFIED" in console
...
def test_successful_integration_does_not_mask_a_later_verify_failure(
    ...
    assert "PYTHON_MOCK_SERVICES_INTEROPERABILITY_FAILED" in capsys.readouterr().out
...
def test_different_maintained_build_blocks_pinned_verification(
    ...
    assert "PYTHON_MOCK_SERVICES_INTEROPERABILITY_FAILED" in output
