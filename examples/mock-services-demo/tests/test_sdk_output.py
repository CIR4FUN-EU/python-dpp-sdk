...
from dpp_mock_services_demo.__main__ import _report
from dpp_mock_services_demo.reporting import DemoReport, ScenarioResult, ScenarioStatus, render_text
...
def test_sdk_text_is_a_detailed_mode_specific_walkthrough() -> None:
    ...
    assert "PYTHON_MOCK_SERVICES_INTEROPERABILITY_INCOMPLETE" not in text
